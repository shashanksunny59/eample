...
const float mxLt = 2.7956988, miLt = 1.7497556, ctmxLt = 3.08567,ctNorLt= 1.5; // max values for 270 and 170 volt
...
void whileCurrent()
{
  ...
  if  (outputValue[1] > ctmxLt)  // Oc
  {
    ...
    unsigned short currentripcount = 30;
    unsigned long  octime = millis();
    unsigned short    octimeout= 50;

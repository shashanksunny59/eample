...
//  Serial.println(millis());// setting vref  
  if( ((millis()-preValueTime) > 50000) )
 {
  ...
  tempValue = (tempValue*(4.93/0.842))+0.08;
  if ((tempValue > 4.8 ) && (tempValue < 5.12))
  {
    vref = tempValue;
  }
  Serial.print(" vref ");
...
//  Serial.print("end measuremaxmin ");
//  Serial.println(millis());
}
